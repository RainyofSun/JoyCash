...
@objcMembers class JCAPPDeviceNetObserver: NSObject {
    enum NetworkStatus {
    ...
    //单例
    static let shared = JCAPPDeviceNetObserver()
    ...
    @objc func reachabilityChanged(note: NSNotification) {
        ...
        setNetState(reach: reachability)
        JCAPPProductLog.debug("+++++++++++ 当前网络状态: \(self.netState)++++++++++++++")
